...
class ChatRoomLayoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setSupportActionBar(binding.appBarChatRoomLayout.toolbar)

        binding.appBarChatRoomLayout.fab.setOnClickListener { view ->
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_chat_room_layout)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.chat_room_layout, menu)
        return true
    }
